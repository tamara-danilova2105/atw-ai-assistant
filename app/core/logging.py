...
def _drop_sensitive_fields(_, __, event_dict: Dict[str, Any]) -> Dict[str, Any]:
...
def configure_logging() -> None:
    ...
    logging.basicConfig(
        ...
        level=getattr(logging, settings.log_level.upper(), logging.INFO), # уровень логирования из настроек, по умолчанию INFO
    )
    ...
    structlog.configure(
        ...
        processors=[
            ...
            structlog.processors.TimeStamper(fmt="iso"), # добавляем timestamp в поле "timestamp" в формате ISO 8601
